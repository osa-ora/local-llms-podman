# Deploy LLMs on your local machine using Podman Desktop "AI Lab" plugin
In this tutorial we will use the Podman desktop and its plugin "AI Lab" to deploy and interact with DeepSeek model.
